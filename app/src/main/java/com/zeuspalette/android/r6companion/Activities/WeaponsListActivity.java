...
import com.zeuspalette.android.r6companion.Helpers.WeaponListHelper;
...
public class WeaponsListActivity extends AppCompatActivity {
    ...
    private void setupMachineWeapon() {
        ...
        ViewGroup head = findViewById(R.id.weapon_list_head);


        for (int i = 0; i < 4; i++) {


            View weapon = layoutInflater.inflate(R.layout.weapon_list_image, null);
            TextView weaponName = weapon.findViewById(R.id.weapon_name);
            ImageView weaponView = weapon.findViewById(R.id.weapon_image);
            weaponName.setText(machineWeaponsName[i]);
            ...
            head.addView(weapon, i, layoutParams);
            final int tmp = i;

            Picasso.with(WeaponsListActivity.this).load(machineWeaponsDrawable[i]).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).resize(zUtils.getPixelfromDP(WeaponsListActivity.this,300),zUtils.getPixelfromDP(WeaponsListActivity.this,111)).into(weaponView);
            ...
            weaponListHelper.setupMachineOperatorsInView(WeaponsListActivity.this, weapon, machineWeapons[i]);
    ...
    private void setupLMGWeapon() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            TextView weaponName = weapon.findViewById(R.id.weapon_name);
            ImageView weaponView = weapon.findViewById(R.id.weapon_image);
            weaponName.setText(lmgWeaponsName[i]);
            ...
            Picasso.with(WeaponsListActivity.this).load(lmgWeaponsDrawable[i]).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).resize(zUtils.getPixelfromDP(WeaponsListActivity.this,300),zUtils.getPixelfromDP(WeaponsListActivity.this,111)).into(weaponView);
            ...
            weaponListHelper.setupLMGOperatorsInView(WeaponsListActivity.this, weapon, lmgWeapons[i]);
    ...
    private void setupPistolWeapon() {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            TextView weaponName = weapon.findViewById(R.id.weapon_name);
            ImageView weaponView = weapon.findViewById(R.id.weapon_image);
            weaponName.setText(pistolWeaponsName[i]);
            ...
            Picasso.with(WeaponsListActivity.this).load(pistolWeaponsDrawable[i]).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).resize(zUtils.getPixelfromDP(WeaponsListActivity.this,300),zUtils.getPixelfromDP(WeaponsListActivity.this,111)).into(weaponView);
            ...
            weaponListHelper.setupPistolOperatorsInView(WeaponsListActivity.this, weapon, pistolWeapons[i]);
        }
    }
    ...
    private void setupSubmachineWeapon() {
        ...
        for (int i = 0; i < 16; i++) {
            ...
            TextView weaponName = weapon.findViewById(R.id.weapon_name);
            ImageView weaponView = weapon.findViewById(R.id.weapon_image);
            weaponName.setText(submachineWeaponsName[i]);
            ...
            Picasso.with(WeaponsListActivity.this).load(submachineWeaponsDrawable[i]).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).resize(zUtils.getPixelfromDP(WeaponsListActivity.this,300),zUtils.getPixelfromDP(WeaponsListActivity.this,111)).into(weaponView);
            ...
            weaponListHelper.setupSubmachineOperatorsInView(WeaponsListActivity.this, weapon, submachineWeapons[i]);
    ...
    private void setupDMRWeapon() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            TextView weaponName = weapon.findViewById(R.id.weapon_name);
            ImageView weaponView = weapon.findViewById(R.id.weapon_image);
            weaponName.setText(dmrWeaponsName[i]);
            ...
            Picasso.with(WeaponsListActivity.this).load(dmrWeaponsDrawable[i]).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).resize(zUtils.getPixelfromDP(WeaponsListActivity.this,300),zUtils.getPixelfromDP(WeaponsListActivity.this,111)).into(weaponView);
            ...
            weaponListHelper.setupDMROperatorsInView(WeaponsListActivity.this, weapon, dmrWeapons[i]);
    ...
    private void setupSniperWeapon() {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            TextView weaponName = weapon.findViewById(R.id.weapon_name);
            ImageView weaponView = weapon.findViewById(R.id.weapon_image);
            weaponName.setText(sniperWeaponsName[i]);
            ...
            Picasso.with(WeaponsListActivity.this).load(sniperWeaponsDrawable[i]).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).resize(zUtils.getPixelfromDP(WeaponsListActivity.this,300),zUtils.getPixelfromDP(WeaponsListActivity.this,111)).into(weaponView);
            ...
            weaponListHelper.setupSniperOperatorsInView(WeaponsListActivity.this, weapon, sniperWeapons[i]);
    ...
    private void setupAssaultWeapon() {
        ...
        for (int i = 0; i < 18; i++) {
            ...
            TextView weaponName = weapon.findViewById(R.id.weapon_name);
            ImageView weaponView = weapon.findViewById(R.id.weapon_image);
            weaponName.setText(assaultWeaponsName[i]);
            ...
            Picasso.with(WeaponsListActivity.this).load(assaultWeaponsDrawable[i]).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).resize(zUtils.getPixelfromDP(WeaponsListActivity.this,300),zUtils.getPixelfromDP(WeaponsListActivity.this,111)).into(weaponView);
            ...
            weaponListHelper.setupAssaultOperatorsInView(WeaponsListActivity.this, weapon, assaultWeapons[i]);
    ...
    private void setupShotgunWeapon() {
        ...
        for (int i = 0; i < 15; i++) {
            ...
            TextView weaponName = weapon.findViewById(R.id.weapon_name);
            ImageView weaponView = weapon.findViewById(R.id.weapon_image);
            weaponName.setText(shotgunWeaponNames[i]);
            ...
            Picasso.with(WeaponsListActivity.this).load(shotgunWeaponsDrawable[i]).memoryPolicy(MemoryPolicy.NO_CACHE, MemoryPolicy.NO_STORE).resize(zUtils.getPixelfromDP(WeaponsListActivity.this,300),zUtils.getPixelfromDP(WeaponsListActivity.this,111)).into(weaponView);
            ...
            weaponListHelper.setupShotgunOperatorsInView(WeaponsListActivity.this, weapon, shotgunWeapons[i]);
